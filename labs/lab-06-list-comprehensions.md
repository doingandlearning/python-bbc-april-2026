...
- First headline should have 8 words, second should have 5 words, etc.

### **Check Your Work**

- Does your list have 10 numbers?
- Is the first number 8 (for "General election: Labour and Tories clash over tax")?
- Is the second number 5 (for "England crowned T20 world champions")?
...
- You should see headlines like "England crowned T20 world champions" (5 words)
...
```
headline_lengths: [8, 5, 8, 10, 7, 8, 6, 8, 7, 9]
...
2. "England crowned T20 world champions" (5 words)
...
- **Step 2**: `[8, 5, 8, 10, 7, 8, 6, 8, 7, 9]`
- **Step 3**: Headlines with ≤7 words: 5, 7, 6, 7
